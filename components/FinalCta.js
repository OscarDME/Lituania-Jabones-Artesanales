...
const BASE_CHECKOUT_URL = "https://www.oriopay.app/p/ranku-darbo-muilu-receptai";
...
export default function FinalCta() {
    ...
    try {
      ...
      if (typeof window !== "undefined") {
        ...
        window.dataLayer.push({
          ...
          items: [
            {
              item_id: "ecoherbal_jabones_final",
  ...
  return (
    <section
      ...
      className="relative w-full py-20 md:py-28 px-4 md:px-6 bg-gradient-to-br from-[var(--color-cream)] via-white to-[var(--color-brand-light)]/40 overflow-hidden"
    >
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-10 right-10 w-72 h-72 bg-[var(--color-brand-light)] rounded-full blur-3xl opacity-60" />
        <div className="absolute bottom-10 left-10 w-80 h-80 bg-[var(--color-cream-deep)] rounded-full blur-3xl opacity-60" />
      </div>
